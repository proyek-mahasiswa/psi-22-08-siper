      ...
      <td class=cardForm>
        <div class="card mb-3" style="max-width: 490px;">
          <div class="row g-0">
            ...
            <td>
            <button type="submit" value="submit"class="btn btn-primary" >Dikembalikan</button>
            <button type="submit" value="submit"class="btn btn-warning" >Hilang</button>
            <button type="submit" value="submit" class="btn btn-danger">Rusak</button>
            </td>
      </td>
</table>
