    ...
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="/css/petugas-perpanjangan.html">
                      ...
                      <a class="nav-link" href="#scrollspyHeading3">Contact Us</a>
                       ...
                       <li class="nav-item dropdown">
                         ...
                         <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                          <li><a href="petugas-profile.html"class="dropdown-item" href="#">Profil</a></li>
                          <li><a href="petugas-daftar buku.html" class="dropdown-item" href="#">Riwayat</a></li>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="petugas-edit buku.html" class="btn btn-primary">Edit</a>
          </div>
        </div>
      </div>
      <br>
