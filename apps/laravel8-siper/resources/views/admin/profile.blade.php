      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="admin/dashboard-pengunjung">Home</a>
            </li>
                <li class="nav-item">
                  <a class="nav-link" href="admin/dashboard-pengunjung">Book</a>
                </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#scrollspyHeading3">Contact Us</a>
                       ...
                       <li class="nav-item dropdown">
                         ...
                         <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                          <li><a href="editprofile-admin.html"class="dropdown-item" href="editprofile-admin.html">Profile</a></li>
...
<div class="button-update-profile-admin">
            <a type="submit" class="btn btn-primary" href="editprofile-admin.html" role="button"> Update </a>
            <a type="button" class="btn btn-secondary" href="homepage_admin.html" role="button"> Back </a>
              </div>
    </div>
  </body>
  </html>